      ...
      <Grid container spacing={6}>
        ...
        <Grid item xs={12}>
          <Card sx={{ mt: '-15px' }}>
            <CardContent>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                {userInfo.isAutogeneratedInvoice ? (
                  <Button variant='outlined' onClick={handleConfirmationModal} startIcon={<InvoiceIcon />}>
                    Cambiar a pago con factura
                  </Button>
                ) : (
                  <Button variant='outlined' onClick={handleConfirmationModal} startIcon={<InvoiceIcon />}>
                    Cambiar a pago sin factura
                  </Button>
                )}
              </Box>
            </CardContent>
